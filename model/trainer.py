...
class MultimodalTrainer:
    ...
    def train_epoch(self, dataloader):
        ...
        for batch_idx, batch in enumerate(dataloader):
            if batch_idx % 10 == 0:
                logging.info(f"🔄 배치 {batch_idx}/{len(dataloader)} 처리 중...")
