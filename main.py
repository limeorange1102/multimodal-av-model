...
def main():
    ...
    train_loader = DataLoader(train_dataset, batch_size=8, shuffle=True, num_workers=8, collate_fn=collate_fn, pin_memory=True)
    ...
    unfreeze_middle_layers(audio_encoder.model)
